package vn.codezx.arise.controllers.assets;
...
public class FileController {
    ...
    public ResponseEntity<Resource> serveFile(@PathVariable("request-id") String requestId,
        ...
        if (!Files.exists(filePathToServe) || !Files.isRegularFile(filePathToServe)) {
            ...
            throw new AriseException(MessageCode.MESSAGE_FILE_NOT_FOUND,
        ...
        try {
            ...
            throw new AriseException(MessageCode.MESSAGE_FILE_SERVE_ERROR,

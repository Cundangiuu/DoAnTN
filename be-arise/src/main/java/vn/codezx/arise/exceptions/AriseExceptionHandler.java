...
import vn.codezx.arise.dtos.ErrorMessageResponseDTO;
import vn.codezx.arise.utils.MessageUtil;

@ControllerAdvice(basePackages = "vn.codezx.arise")
@Slf4j
public class AriseExceptionHandler {
    private final MessageUtil messageUtil;

    public AriseExceptionHandler(MessageUtil messageUtil) {
    ...
    @ExceptionHandler({AriseException.class})
    public ResponseEntity<ErrorMessageResponseDTO> tveExceptionHandle(AriseException ex) {

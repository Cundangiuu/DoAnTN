...
public interface InvoiceRepository extends JpaRepository<Invoice, Integer> {
  ...
  @Query("SELECT i FROM Invoice i "
      ...
      + "LOWER(i.enrollment.classArise.name) LIKE LOWER(CONCAT('%', :searchString, '%')) OR "
  ...
  @Modifying
  @Query("UPDATE Invoice i SET i.isDelete = true WHERE i.enrollment.student.id IN (:id) AND i.enrollment.classArise.id = :classId")
  void softDeleteInvoiceMappingByListStudent(@Param("id") List<Integer> id,
      @Param("classId") int classId);


  @Modifying
  @Query("UPDATE Invoice i SET i.isDelete = true WHERE i.enrollment.classArise.id = :id")
  ...
  @Query("SELECT i FROM Invoice i WHERE i.enrollment.classArise.id = :classId and i.isDelete = false")

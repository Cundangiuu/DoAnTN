...
public interface ClassTvmsRepository extends JpaRepository<ClassTvms, Integer> {
  ...
  Optional<ClassTvms> findTop1ByCreatedAtBetweenAndIsDeleteIsFalseOrderByCodeDesc(
      Date startOfDay, Date endOfDay);

  Optional<ClassTvms> findTop1ByCreatedAtBetweenOrderByCodeDesc(Date startOfDay,
      Date endOfDay);
  ...
  Page<ClassTvms> searchClassByStaff(
  ...
  Page<ClassTvms> searchOnGoingClass(
      @Param("searchString") String searchString,
      Pageable pageable
  );
  ...
  Page<ClassTvms> searchOnGoingClassByStaff(
      @Param("searchString") String searchString,
      @Param("staffId") int staffId,
      Pageable pageable
  );
  ...
  Page<ClassTvms> searchNewClassByStaff(
      @Param("searchString") String searchString,
      @Param("staffId") int staffId,
      Pageable pageable
  );
  ...
  Page<ClassTvms> searchEndedClass(
      @Param("searchString") String searchString,
      Pageable pageable
  );
  ...
  Page<ClassTvms> searchEndedClassByStaff(
      @Param("searchString") String searchString,
      @Param("staffId") int staffId,
      Pageable pageable
  );
  ...
  @Query(value = """
        ...
        ct.is_delete = false
      """, nativeQuery = true)
  List<ClassTvms> findAllByClassDayRange(@Param("startDate") Date startDate,
  ...
  @Query(value = """
      ...
      """, nativeQuery = true)
  List<ClassTvms> findAllByClassDayRangeOverlaping(@Param("startDate") Date startDate,
      @Param("endDate") Date endDate);

  List<ClassTvms> findAllByIsDeleteFalse();
}

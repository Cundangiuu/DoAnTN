...
const CourseTable: React.FC = () => {
  ...
  const columns = [
    { name: "Course Code", key: "code", align: "start" },
    { name: "Course Name", key: "name", align: "start" },
    { name: "Tuition Fee", key: "tuitionRate", align: "start" },
    { name: "Hours", key: "numberOfHour", align: "start" },
